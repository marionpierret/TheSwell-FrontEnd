...
export const register = abc => {
    return (
        axios.post('https://the-swell-back-l995xjdt2-marionpierret.vercel.app/auth/register', {
...
export const login = user => {
    return axios.post('https://the-swell-back-l995xjdt2-marionpierret.vercel.app/auth/login', {
        email : user.email,
